...
if (argv.includes('--규격')) {
  ...
  const 본문 = [
    ...
    '',
    '「632 / 37 / 26」 은   안폭 632px · 한 줄에 37자 · 그 칸이 모두 26줄',
    '',
    '한 칸이 몇 줄을 먹는지 세는 법',
    '  ① 요소마다 줄 수를 센다',
    '       제목 1 · 출처 1 · 목록 항목 하나가 1 · 표 (행 수 + 헤더 1)',
    '       그림 자리 6 · 비움 단계띠 3 · 지도 8',
    '       문단 = 글자수 ÷ 한 줄 글자수 · **올림**',
    '  ② **요소 사이마다 1줄을 더한다** · 첫 요소 앞과 출처 앞은 0이다',
    '  ③ 그 합이 「총 줄」을 넘으면 넘친 것이다',
    '',
    '  보기 · G1 카피 한 칸은 총 21줄이다. 제목 + 문단 여섯 + 출처를 넣으면',
    '        제목 1 + 출처 1 + 사이 간격 6 = 8줄이 뼈대로 나간다.',
    '        **글에 쓸 수 있는 것은 13줄**이고 · 한 줄이 117자니 1521자다.',
    '',
    '  **한 박스 안에서** 요소를 쪼갤수록 간격이 먹는다 · 문단 여섯보다 문단 셋이 300자를 더 담는다.',
    '  나눌 곳은 요소가 아니라 **박스**다 · 박스를 나누면 간격이 다시 0에서 시작한다 · 규격서 §1-1.',
    '',
